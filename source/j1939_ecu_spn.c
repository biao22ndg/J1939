...
bool j1939_ecu_spn_init(void)
{
    ...
    bsp_tim_reg_cbk_10ms(j1939_spn_update); // 注册定时事件管理任务
    return true;
}
...
SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0) | SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC), /* 属性 */
                 j1939showctrl,                                                 /* 命令名 */
                 j1939_ecu_spn_show_ctrl,                                       /* 函数 */
                 "j1939showctrl:显示J1939的所有控制参数");                      /* 描述 */
#endif
...
SHELL_EXPORT_CMD(SHELL_CMD_PERMISSION(0) | SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC), /* 属性 */
                 j1939spnprt,                                                   /* 命令名 */
                 j1939_ecu_spn_info_print,                                      /* 函数 */
                 "j1939spnprt:打印SPN编号与中文定义对照表");                    /* 描述 */
#endif
